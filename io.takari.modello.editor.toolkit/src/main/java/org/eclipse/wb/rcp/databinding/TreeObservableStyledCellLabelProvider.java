...
public class TreeObservableStyledCellLabelProvider extends StyledCellLabelProvider implements ILabelProvider {
	...
	//
	////////////////////////////////////////////////////////////////////////////
	public TreeObservableStyledCellLabelProvider(IObservableSet allElementsObservable,
			Class<?> beanClass,
			String textProperty,
	...
	private StyledString getStyledText(Object element) {
		...
		return new StyledString(text == null ? "" : text.toString());
	}
	...
	public void update(ViewerCell cell) {
		...
		StyledString ss = getStyledText(element);
	...
	private final PropertyChangeListener m_propertiesListener = new PropertyChangeListener() {
		...
		public void propertyChange(PropertyChangeEvent event) {
			LabelProviderChangedEvent newEvent =
					new LabelProviderChangedEvent(TreeObservableStyledCellLabelProvider.this, event.getSource());
